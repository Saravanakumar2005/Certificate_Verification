...
export default function View() {
  ...
  return (
    <div className='flex flex-col h-screen'>
      ...
      {modalVisible && (
        <div className='fixed inset-0 top-1 flex items-center justify-center bg-gray-700 bg-opacity-50'>
      ...
      <div className=' flex items-center top-0 -z-10 justify-center z-auto'>
          <Carousel />
        </div>
